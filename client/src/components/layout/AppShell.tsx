...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const internalNavItems: Record<string, { icon: any; label: string; href: string }> = {
    ...
    daily_agenda: { icon: ClipboardList, label: "Daily Agenda", href: "/daily-agenda" },
  ...
  const sidebarSections: NavSection[] = [
    ...
    { label: "ADMIN", items: ["admin", "hiring", "invoices", "reports", "budget_settings", "customer_messages", "customer_blasts"] },
  ];

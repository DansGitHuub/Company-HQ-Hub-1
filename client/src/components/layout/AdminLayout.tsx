...
const ADMIN_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { value: "users", label: "Users", icon: Users, tab: "users" },
      { value: "requests", label: "HR Communications", icon: Megaphone, tab: "requests" },
      { value: "agreements", label: "Agreement Templates", icon: FileSignature, tab: "agreements" },
      { value: "suggestions", label: "Suggestions", icon: Lightbulb, tab: "suggestions" },
    ],
  },
  {
    id: "settings",
    ...
    items: [
      ...
      { value: "divisions", label: "Divisions", icon: Layers, tab: "divisions" },
      ...
      { value: "quickbooks", label: "QuickBooks Settings", icon: DollarSign, tab: "quickbooks" },
  ...
  },
  {
    ...
    items: [
      ...
      { value: "documents", label: "Documents", icon: FileText, tab: "documents" },
      { value: "shared-links", label: "Shared Links", icon: ExternalLink, tab: "shared-links" },
    ],
  },
  {
    id: "system-advanced",
    ...
    items: [
      ...
      { value: "todos", label: "Task Access", icon: CheckCircle, tab: "todos" },
      ...
      { value: "help-reports", label: "Help Reports", icon: HelpCircle, tab: "help-reports" },

...
import { registerCustomerMessagingRoutes } from "./customerMessagingRoutes";
...
import { registerWorksheetsApiRoutes } from "./worksheetsApiRoutes";
...
import { registerRouteRoutes } from "./routeRoutes";
import { registerWorksheetPhotoRoutes } from "./worksheetPhotoRoutes";
import { registerSettingsRoutes } from "./settingsRoutes";
import { registerDailyLogRoutes } from "./dailyLogRoutes";
...
import { registerWeatherRoutes } from "./weatherRoutes";
...
import { migrateMeetingNotesTable, registerMeetingNotesRoutes } from "./meetingNotesRoutes";
...
import { registerJobLineItemsRoutes } from "./jobLineItemsRoutes";
...
Provide accurate information based on publicly available documentation.`;
  ...
  registerWorksheetsApiRoutes(app, requireAuth);
  ...
  registerDailyPlanRoutes(app, requireAuth);
  registerAdminDashboardRoutes(app, requireAuth);
  await migrateMeetingNotesTable();
  registerMeetingNotesRoutes(app, requireAuth);
  ...
  registerJobLineItemsRoutes(app);
  ...
  registerWeatherRoutes(app, requireAuth);
